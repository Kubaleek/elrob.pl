...
export default function Navbar() {
  ...
  return (
    <div className="sticky left-0 top-0 z-40 w-full bg-[#0C0C0C]/90 backdrop-blur-lg py-1">
      <header>
                              ...
                              <li key={item.id}>
                                <NavigationMenuLink asChild>
                                  ...
                                  >
                                    ...
                                    <p
                                      className={`text-xs text-[#c8cbce] leading-relaxed text-balanc`}
                                    >
                                      {item.customText}
                                    </p>
                                  </Link>
                              ...
                              <li key={item.id}>
                                <NavigationMenuLink asChild>
                                  ...
                                  >
                                    ...
                                    <p
                                      className={`text-xs text-[#c8cbce] leading-relaxed text-balance`}
                                    >
                                      {item.customText}
                                    </p>
                                  </Link>
